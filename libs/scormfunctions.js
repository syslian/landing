...
{
    console.log("Encontrando el API");
           ...
           (win.parent != win) )
   {
      ...
      findAPITries++;
       console.log("Intentos de entrar al API: "+findAPITries);
...
function getAPI()
{
   console.log("Llamando a findAPI");
        ...
        (typeof(window.opener) != "undefined") )
   {
      // try to find the API in the current window�s opener
       console.log("entro a PI null window opener");
...
function ScormProcessInitialize(){
    console.log("Dentro de la función ScormProcessInitialize");
    var result;
    ...
    console.log("API.LMSInitialize: "+result);
    if (result == SCORM_FALSE){
        console.log("Scorm false");
...
function ScormProcessGetValue(element){
    ...
    console.log("Consultando LMSGetValue "+element);
    if (result == ""){
